...
import uberhome from "../assets/bemutatkozooldalhatter.png";
    ...
    >
      <div className="w-screen h-full flex flex-col bg-gray-700 overflow-y-auto bg-opacity-60 items-start justify-start max-sm:py-0 sm:justify-center px-10 sm:px-[150px]">
        ...
        <button
          ...
          className="relative overflow-hidden hover:bg-white delay-100 max-sm:self-end bg-transparent border-2 border-white text-white text-[32px] font-bold rounded-full px-6 flex items-center gap-4 py-3 max-h-[68px] justify-center group transition-all duration-1000 mt-14 sm:mt-4"
        >
